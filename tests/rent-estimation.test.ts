...
const metadata = { title: "Vuokraindeksi (2025=100) ja keskineliövuokrat muuttujina", variables: [
  ...
  { code: "area", text: "Alue", values: ["MK01", "091", "MK15", "905"], valueTexts: ["MK01 Uusimaa", "Helsinki", "MK15 Pohjanmaa", "Vaasa"] },
  { code: "time", text: "Vuosineljännes", values: ["2026Q1", "2025Q4", "2026Q2"], valueTexts: ["2026Q1", "2025Q4", "2026Q2"], time: true },
