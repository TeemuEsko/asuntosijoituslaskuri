...
export type PropertyModel = {
  ...
  financing: { equityInvested: PropertyField<number>; bankLoanAmount: PropertyField<number>; referenceRate: PropertyField<number>; marginRate: PropertyField<number>; annualInterestRate: PropertyField<number>; loanTermYears: PropertyField<number>; repaymentType: PropertyField<"annuity" | "fixed_payment" | "equal_principal" | "interest_only" | "bullet">; interestOnlyMonths: PropertyField<number>; collateralValue: PropertyField<number>; extraCollateral: PropertyField<number> };
