...
export function AnalysisCoverageCard({ documentKinds = [], listingRenovationsFound = false, onDocumentAdded }: { documentKinds?: RepairDocumentKind[]; listingRenovationsFound?: boolean; onDocumentAdded?: (kind: RepairDocumentKind) => void }) {
