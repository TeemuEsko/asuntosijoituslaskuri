...
export function WorkspaceSidebar() {
  return (
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-60 border-r bg-sidebar lg:flex lg:flex-col">
      <div className="flex h-17 items-center gap-2 border-b px-5"><div className="grid size-8 place-items-center rounded-lg bg-success text-white"><Building2 className="size-4" /></div><span className="font-semibold">PropertyOS</span><Badge variant="outline" className="ml-auto px-1.5 text-[10px]">Early Access</Badge></div>
      ...
      <div className="mt-auto border-t p-4 text-xs leading-relaxed text-muted-foreground">Foundation v2.1 RC<br />Property Workspace</div>
    </aside>
  );
}
